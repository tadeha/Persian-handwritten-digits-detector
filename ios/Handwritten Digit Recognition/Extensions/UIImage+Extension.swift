...
extension UIImage {
  ...
  var noiseReducted: UIImage? {
    ...
    guard let currentFilter = CIFilter(name: "CINoiseReduction") else { return nil }
    currentFilter.setValue(CIImage(image: self), forKey: kCIInputImageKey)
    currentFilter.setValue(0.99, forKey: "inputNoiseLevel")
    currentFilter.setValue(0.99, forKey: "inputSharpness")
